...
import { CustomLineItem, DirectDiscount, InventoryMode, LineItem, RoundingMode, ShippingInfo, ShippingRateInput, TaxCalculationMode, TaxedPrice, TaxMode } from "./cart.js";
 ...
 *
 */
export type QuoteState = 'Accepted' | 'Declined' | 'DeclinedForRenegotiation' | 'Failed' | 'Pending' | 'RenegotiationAddressed' | 'Withdrawn' | string;
...
export type QuoteUpdateAction = QuoteChangeCustomerAction | QuoteChangeQuoteStateAction | QuoteRequestQuoteRenegotiationAction | QuoteSetCustomFieldAction | QuoteSetCustomTypeAction | QuoteTransitionStateAction;
/**
